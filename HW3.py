...
rus = {1:'АВЕИНОРСТ',
      	...
      	8:'ШЭЮ',
      	10:'ФЩЪ'}
layout = abs(int(input('Введите 1 для английской раскладки. 0 для русской : ')))
word = input('Введите слово: ').upper()
if layout == 1:
	print('Вы получаете', sum([key for i in word for key, value in eng.items() if i in value]), 'очков')
else:
	print('Вы получаете', sum([key for i in word for key, value in rus.items() if i in value]), 'очков')